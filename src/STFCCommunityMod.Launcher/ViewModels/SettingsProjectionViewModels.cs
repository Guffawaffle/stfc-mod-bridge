...
public sealed class AdvancedPatchEditingGateViewModel : SettingsListItemViewModel
{
    ...
    public string StateDescription => IsUnlocked
        ? "Patch controls are available for this Mod Bridge session. Lock them again when you are finished editing."
    ...
    public string EnableAvailability => IsConfigurationAvailable
        ? "Acknowledge the warning to enable patch controls for this Mod Bridge session."
